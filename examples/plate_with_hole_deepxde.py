...
def main():
    ...
    # Use analytic Dirichlet on outer edges so corners can reach the analytic (r-a)^2 values
    bc_outer_v = dde.DirichletBC(geom_for_data, analytic_outer, on_outer_vertical)
    bc_outer_h = dde.DirichletBC(geom_for_data, analytic_outer, on_outer_horizontal)
